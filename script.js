...
var queue = [];
        ...
        function calculateQueue(value){
            ...
            var valnewarr=[];
            for(var keyvall in value)
            {

                if(value[keyvall] == '(' || value[keyvall] == ')' || value[keyvall] == '0')
                {
                    
                }else
                {
                    valnewarr.push(value[keyvall]);
                }
            }
            value=valnewarr;
            queue=valnewarr;
